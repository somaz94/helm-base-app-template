...
Common labels
*/}}
{{- define "base-gcp.labels" -}}
helm.sh/chart: {{ include "base-gcp.chart" . }}
{{ include "base-gcp.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "base-gcp.selectorLabels" -}}
app.kubernetes.io/name: {{ include "base-gcp.name" . }}
...
*/}}
{{- define "base-gcp.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "base-gcp.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- define "base-gcp.podTemplate" }}
    metadata:
      annotations:
        ...
        {{- end }}
      labels:
        {{- include "base-gcp.selectorLabels" . | nindent 8 }}
        {{- if .Values.version }}
    ...
    spec:
      ...
      imagePullSecrets:
        {{- toYaml . | nindent 8 }}
      {{- end }}
      serviceAccountName: {{ include "base-gcp.serviceAccountName" . }}
      ...
      {{- end }}
      containers:
        - name: {{ include "base-gcp.fullname" . }}
          ...
          {{- if $hasExternalSecrets }}
            ...
            - secretRef:
                name: {{ include "base-gcp.fullname" . }}-secret
          {{- end }}
          {{- end }}
          ports:
            - name: http
